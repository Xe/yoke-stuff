...
$`yoke stow ./postgres.wasm oci://registry.int.xeserv.us/crds/db/postgres/flight:${git.tag()}`;
$`yoke stow ./postgres-airway.wasm oci://registry.int.xeserv.us/crds/db/postgres/airway:${git.tag()}`;
