...
type ControlPlaneIngress struct {
	...
	Spec map[string]interface{} `json:"spec,omitempty" yaml:"spec,omitempty" mapstructure:"spec,omitempty"`
}
...
type ControlPlanePersistence struct {
	...
	AddVolumes []map[string]interface{} `json:"addVolumes,omitempty" yaml:"addVolumes,omitempty" mapstructure:"addVolumes,omitempty"`
	...
	BinariesVolume []map[string]interface{} `json:"binariesVolume,omitempty" yaml:"binariesVolume,omitempty" mapstructure:"binariesVolume,omitempty"`

	// Allows you to override the dataVolume. Only works correctly if
	// volumeClaim.enabled=false.
	DataVolume []map[string]interface{} `json:"dataVolume,omitempty" yaml:"dataVolume,omitempty" mapstructure:"dataVolume,omitempty"`
	...
	VolumeClaimTemplates []map[string]interface{} `json:"volumeClaimTemplates,omitempty" yaml:"volumeClaimTemplates,omitempty" mapstructure:"volumeClaimTemplates,omitempty"`
}
...
type ControlPlaneScheduling struct {
	...
	Tolerations []map[string]interface{} `json:"tolerations,omitempty" yaml:"tolerations,omitempty" mapstructure:"tolerations,omitempty"`
...
type ControlPlaneSecurity struct {
	...
	// level.
	ContainerSecurityContext map[string]interface{} `json:"containerSecurityContext,omitempty" yaml:"containerSecurityContext,omitempty" mapstructure:"containerSecurityContext,omitempty"`

	// PodSecurityContext specifies security context options on the pod level.
	PodSecurityContext map[string]interface{} `json:"podSecurityContext,omitempty" yaml:"podSecurityContext,omitempty" mapstructure:"podSecurityContext,omitempty"`
}
...
type DistroK0S struct {
	...
	SecurityContext map[string]interface{} `json:"securityContext,omitempty" yaml:"securityContext,omitempty" mapstructure:"securityContext,omitempty"`
}
...
type ExperimentalMultiNamespaceMode struct {
	...
	// namespace.
	NamespaceLabels map[string]string `json:"namespaceLabels,omitempty" yaml:"namespaceLabels,omitempty" mapstructure:"namespaceLabels,omitempty"`
}
...
type FromHostMappings struct {
	...
	ByName map[string]string `json:"byName,omitempty" yaml:"byName,omitempty" mapstructure:"byName,omitempty"`
}
...
type LimitRange struct {
	...
	Default map[string]interface{} `json:"default,omitempty" yaml:"default,omitempty" mapstructure:"default,omitempty"`

	// DefaultRequest are the default request options for the limit range
	DefaultRequest map[string]interface{} `json:"defaultRequest,omitempty" yaml:"defaultRequest,omitempty" mapstructure:"defaultRequest,omitempty"`
	...
	Max map[string]interface{} `json:"max,omitempty" yaml:"max,omitempty" mapstructure:"max,omitempty"`

	// Min are the min limits for the limit range
	Min map[string]interface{} `json:"min,omitempty" yaml:"min,omitempty" mapstructure:"min,omitempty"`
}
...
type Plugin struct {
	...
	Lifecycle map[string]interface{} `json:"lifecycle,omitempty" yaml:"lifecycle,omitempty" mapstructure:"lifecycle,omitempty"`

	// LivenessProbe corresponds to the JSON schema field "livenessProbe".
	LivenessProbe map[string]interface{} `json:"livenessProbe,omitempty" yaml:"livenessProbe,omitempty" mapstructure:"livenessProbe,omitempty"`
	...
	ReadinessProbe map[string]interface{} `json:"readinessProbe,omitempty" yaml:"readinessProbe,omitempty" mapstructure:"readinessProbe,omitempty"`
	...
	StartupProbe map[string]interface{} `json:"startupProbe,omitempty" yaml:"startupProbe,omitempty" mapstructure:"startupProbe,omitempty"`
...
type RBACClusterRole struct {
	...
	ExtraRules []map[string]interface{} `json:"extraRules,omitempty" yaml:"extraRules,omitempty" mapstructure:"extraRules,omitempty"`

	// OverwriteRules will overwrite the cluster role rules completely.
	OverwriteRules []map[string]interface{} `json:"overwriteRules,omitempty" yaml:"overwriteRules,omitempty" mapstructure:"overwriteRules,omitempty"`
}
...
type ResourceQuota struct {
	...
	Quota map[string]interface{} `json:"quota,omitempty" yaml:"quota,omitempty" mapstructure:"quota,omitempty"`

	// ScopeSelector is the resource quota scope selector
	ScopeSelector map[string]interface{} `json:"scopeSelector,omitempty" yaml:"scopeSelector,omitempty" mapstructure:"scopeSelector,omitempty"`
...
type Selector struct {
	...
	LabelSelector map[string]string `json:"labelSelector,omitempty" yaml:"labelSelector,omitempty" mapstructure:"labelSelector,omitempty"`
}
...
type SyncFromHost struct {
	...
	CustomResources map[string]SyncFromHostCustomResource `json:"customResources,omitempty" yaml:"customResources,omitempty" mapstructure:"customResources,omitempty"`
...
type SyncPods struct {
	...
	// the host cluster
	TranslateImage map[string]string `json:"translateImage,omitempty" yaml:"translateImage,omitempty" mapstructure:"translateImage,omitempty"`
...
type SyncToHost struct {
	...
	CustomResources map[string]SyncToHostCustomResource `json:"customResources,omitempty" yaml:"customResources,omitempty" mapstructure:"customResources,omitempty"`
...
type Values struct {
	...
	Plugins map[string]interface{} `json:"plugins,omitempty" yaml:"plugins,omitempty" mapstructure:"plugins,omitempty"`
